...
import { generateThemeRequestSchema } from "@/lib/ai/prompts";
import { buildSystemPrompt } from "@/lib/ai/prompts";
import { parsePage } from "@/scripts/ingest/parsePage";
...
export async function POST(req: Request) {
    try {
        ...
        const { url, themeStyle, tone, seoGoals } = parsedReq.data;
        ...
        // 3. Build the prompt
        const systemPrompt = buildSystemPrompt(parsedPageData);
